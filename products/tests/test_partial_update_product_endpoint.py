...
class TestPartialCategoryUpdate:

    def test_product_owner_partial_update_category(self, create_category, create_product, api_client, regular_user):
        ...
        response = api_client.patch(reverse('products:product-retrieve-update-destroy', args=[product.id]), updated_data, format='json')
    ...
    def test_product_non_owner_partial_update_category(self, create_category, create_product, api_client, regular_user, another_user):
        # Create a category with the old name ('Category 1')
        old_category = create_category(name='Category 1', description='Description 1')
        new_category = create_category(name='Category 2', description='Description 2')
        product = create_product(user=regular_user, name='Product 1', 
